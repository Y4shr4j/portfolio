...
const research = [
  {
    title: "An Object Detection Model made with YOLO8",
    authors:
      "Yash Raj, Rahul Shah, Akash Das, Tushar Bhattarai",
    conferences:
      " Satyendra Nath Bose Summer Internship Program 2024, NIT Silchar",
    researchYr: 2024,
    citebox: "popup1",
    image: "assets/images/research-page/National_Institute_Of_Technology_Silchar_Logo.svg",
    citation: {
      vancouver:
        "Yash Raj, Rahul Shah, Akash Das, Tushar Bhattarai. Built on Yolov7 which is best for real time detection ,Trained on a custom dataset to detect objects out of scale of the pre-trained ones.",
    },
    abstract:
      " Built on Yolov7 which is best for real time detection. Trained on a custom dataset to detect objects out of scale of the pre-trained ones . Runs on a dedicated Graphical User Interface built using Tkinter .  Built accordingly for easy customisation for various datasets and classes",
    absbox: "absPopup1",
  },
